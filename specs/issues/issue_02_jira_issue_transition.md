...
- **Статус:** Blocked
- **Приоритет:** High
- **Зависит от:** [TNG-01-03: Серверное двухфазное подтверждение мутаций](epic_01/issue_01_03_two_phase_approval.md)
- **Блокирует:** нет
...
Реализация заблокирована до TNG-01-03: новая мутационная команда не должна
появиться раньше общего серверного enforcement подтверждений. После снятия
блокера команда обязана объявить `WRITE/REQUIRED` metadata из EPIC-01.
