...
`JiraPluginTest` (12) — на ktor-client-mock: auth-потоки, list/view/create/comment, перевод ошибок. `./gradlew :plugins:jira:test`. Живой сценарий S6 — через `scripts/e2e.sh` с `TENGU_E2E_JIRA_URL`.
